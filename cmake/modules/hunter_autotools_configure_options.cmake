...
function(hunter_autotools_configure_options configure_opts)
  ...
  cmake_parse_arguments(PARAM "${options}" "${one_value_params}" "${multi_value_params}" ${ARGN})
  if(PARAM_UNPARSED_ARGUMENTS)
    hunter_fatal_error("Invalid arguments passed to hunter_autotools_configure: ${PARAM_UNPARSED_ARGUMENTS}")
  endif()
  ...
  if(HUNTER_STATUS_DEBUG)
    ...
    hunter_status_debug("[hunter] Toolchain Binaries:\n${_toolchain_binaries_new_line}")
  endif()
  # hunter_status_debug("[hunter] Toolchain Binaries: ${_toolchain_binaries}")
  ...
  hunter_status_debug("[hunter] CPPFLAGS=${_cppflags}")
  ...
  hunter_status_debug("[hunter] CFLAGS=${_cflags}")
  ...
  hunter_status_debug("[hunter] CXXFLAGS=${_cxxflags}")
  ...
  hunter_status_debug("[hunter] LDFLAGS=${_ldflags}")
  ...
  if(HUNTER_STATUS_DEBUG)
    ...
    hunter_status_debug("[hunter] EXTRA_FLAGS=${_extra_flags}")
  endif()
