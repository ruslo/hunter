...
## 5.9+ only --
string(COMPARE EQUAL "qtquickcontrols2" "qtcharts" _is_qtcharts)
string(COMPARE EQUAL "qtquickcontrols2" "qtdatavis3d" _is_qtdatavis3d)
string(COMPARE EQUAL "qtquickcontrols2" "qtdocgallery" _is_qtdocgallery)
string(COMPARE EQUAL "qtquickcontrols2" "qtfeedback" _is_qtfeedback)
string(COMPARE EQUAL "qtquickcontrols2" "qtgamepad" _is_qtgamepad)
string(COMPARE EQUAL "qtquickcontrols2" "qtnetworkauth" _is_qtnetworkauth)
string(COMPARE EQUAL "qtquickcontrols2" "qtpim" _is_qtpim)
string(COMPARE EQUAL "qtquickcontrols2" "qtpurchasing" _is_qtpurchasing)
string(COMPARE EQUAL "qtquickcontrols2" "qtqa" _is_qtqa)
string(COMPARE EQUAL "qtquickcontrols2" "qtremoteobjects" _is_qtremoteobjects)
string(COMPARE EQUAL "qtquickcontrols2" "qtrepotools" _is_qtrepotools)
string(COMPARE EQUAL "qtquickcontrols2" "qtscxml" _is_qtscxml)
string(COMPARE EQUAL "qtquickcontrols2" "qtserialbus" _is_qtserialbus)
string(COMPARE EQUAL "qtquickcontrols2" "qtspeech" _is_qtspeech)
string(COMPARE EQUAL "qtquickcontrols2" "qtsystems" _is_qtsystems)
string(COMPARE EQUAL "qtquickcontrols2" "qtvirtualkeyboard" _is_qtvirtualkeyboard)
...
string(COMPARE EQUAL "qtquickcontrols2" "qtdeclarative" _is_qtdeclarative)
