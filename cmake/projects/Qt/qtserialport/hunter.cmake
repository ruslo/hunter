...
if(DEFINED HUNTER_CMAKE_PROJECTS_QT_QTSERIALPORT_HUNTER_CMAKE_)
  return()
else()
  set(HUNTER_CMAKE_PROJECTS_QT_QTSERIALPORT_HUNTER_CMAKE_ 1)
endif()
...
## 5.5 only --
string(COMPARE EQUAL "qtserialport" "qtquick1" _is_qtquick1)
string(COMPARE EQUAL "qtserialport" "qtwebkit" _is_qtwebkit)
string(COMPARE EQUAL "qtserialport" "qtwebkit-examples" _is_qtwebkit_examples)
...
list(FIND _nobuild "qtserialport" _dont_build_it)
if(NOT _dont_build_it EQUAL -1)
  hunter_status_debug(
      "Qt component doesn't install anything and will be skipped: qtserialport"
  )
  return()
endif()

string(COMPARE EQUAL "qtserialport" "qtdeclarative" _is_qtdeclarative)
...
hunter_download(
    PACKAGE_NAME Qt
    PACKAGE_COMPONENT "qtserialport"
