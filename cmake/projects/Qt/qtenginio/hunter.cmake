...
## 5.9 only --
string(COMPARE EQUAL "qtenginio" "qtcharts" _is_qtcharts)
string(COMPARE EQUAL "qtenginio" "qtdatavis3d" _is_qtdatavis3d)
string(COMPARE EQUAL "qtenginio" "qtdocgallery" _is_qtdocgallery)
string(COMPARE EQUAL "qtenginio" "qtfeedback" _is_qtfeedback)
string(COMPARE EQUAL "qtenginio" "qtgamepad" _is_qtgamepad)
string(COMPARE EQUAL "qtenginio" "qtnetworkauth" _is_qtnetworkauth)
string(COMPARE EQUAL "qtenginio" "qtpim" _is_qtpim)
string(COMPARE EQUAL "qtenginio" "qtpurchasing" _is_qtpurchasing)
string(COMPARE EQUAL "qtenginio" "qtqa" _is_qtqa)
string(COMPARE EQUAL "qtenginio" "qtremoteobjects" _is_qtremoteobjects)
string(COMPARE EQUAL "qtenginio" "qtrepotools" _is_qtrepotools)
string(COMPARE EQUAL "qtenginio" "qtscxml" _is_qtscxml)
string(COMPARE EQUAL "qtenginio" "qtserialbus" _is_qtserialbus)
string(COMPARE EQUAL "qtenginio" "qtspeech" _is_qtspeech)
string(COMPARE EQUAL "qtenginio" "qtsystems" _is_qtsystems)
string(COMPARE EQUAL "qtenginio" "qtvirtualkeyboard" _is_qtvirtualkeyboard)
