...
## 5.9+ only --
string(COMPARE EQUAL "qtxmlpatterns" "qtcharts" _is_qtcharts)
string(COMPARE EQUAL "qtxmlpatterns" "qtdatavis3d" _is_qtdatavis3d)
string(COMPARE EQUAL "qtxmlpatterns" "qtdocgallery" _is_qtdocgallery)
string(COMPARE EQUAL "qtxmlpatterns" "qtfeedback" _is_qtfeedback)
string(COMPARE EQUAL "qtxmlpatterns" "qtgamepad" _is_qtgamepad)
string(COMPARE EQUAL "qtxmlpatterns" "qtnetworkauth" _is_qtnetworkauth)
string(COMPARE EQUAL "qtxmlpatterns" "qtpim" _is_qtpim)
string(COMPARE EQUAL "qtxmlpatterns" "qtpurchasing" _is_qtpurchasing)
string(COMPARE EQUAL "qtxmlpatterns" "qtqa" _is_qtqa)
string(COMPARE EQUAL "qtxmlpatterns" "qtremoteobjects" _is_qtremoteobjects)
string(COMPARE EQUAL "qtxmlpatterns" "qtrepotools" _is_qtrepotools)
string(COMPARE EQUAL "qtxmlpatterns" "qtscxml" _is_qtscxml)
string(COMPARE EQUAL "qtxmlpatterns" "qtserialbus" _is_qtserialbus)
string(COMPARE EQUAL "qtxmlpatterns" "qtspeech" _is_qtspeech)
string(COMPARE EQUAL "qtxmlpatterns" "qtsystems" _is_qtsystems)
string(COMPARE EQUAL "qtxmlpatterns" "qtvirtualkeyboard" _is_qtvirtualkeyboard)
