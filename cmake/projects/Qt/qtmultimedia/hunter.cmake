...
## 5.9+ only --
string(COMPARE EQUAL "qtmultimedia" "qtcharts" _is_qtcharts)
string(COMPARE EQUAL "qtmultimedia" "qtdatavis3d" _is_qtdatavis3d)
string(COMPARE EQUAL "qtmultimedia" "qtdocgallery" _is_qtdocgallery)
string(COMPARE EQUAL "qtmultimedia" "qtfeedback" _is_qtfeedback)
string(COMPARE EQUAL "qtmultimedia" "qtgamepad" _is_qtgamepad)
string(COMPARE EQUAL "qtmultimedia" "qtnetworkauth" _is_qtnetworkauth)
string(COMPARE EQUAL "qtmultimedia" "qtpim" _is_qtpim)
string(COMPARE EQUAL "qtmultimedia" "qtpurchasing" _is_qtpurchasing)
string(COMPARE EQUAL "qtmultimedia" "qtqa" _is_qtqa)
string(COMPARE EQUAL "qtmultimedia" "qtremoteobjects" _is_qtremoteobjects)
string(COMPARE EQUAL "qtmultimedia" "qtrepotools" _is_qtrepotools)
string(COMPARE EQUAL "qtmultimedia" "qtscxml" _is_qtscxml)
string(COMPARE EQUAL "qtmultimedia" "qtserialbus" _is_qtserialbus)
string(COMPARE EQUAL "qtmultimedia" "qtspeech" _is_qtspeech)
string(COMPARE EQUAL "qtmultimedia" "qtsystems" _is_qtsystems)
string(COMPARE EQUAL "qtmultimedia" "qtvirtualkeyboard" _is_qtvirtualkeyboard)
