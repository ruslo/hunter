...
if(DEFINED HUNTER_CMAKE_PROJECTS_QT_QTBASE_HUNTER_CMAKE_)
  return()
else()
  set(HUNTER_CMAKE_PROJECTS_QT_QTBASE_HUNTER_CMAKE_ 1)
endif()
...
## 5.5 only --
string(COMPARE EQUAL "qtbase" "qtquick1" _is_qtquick1)
string(COMPARE EQUAL "qtbase" "qtwebkit" _is_qtwebkit)
string(COMPARE EQUAL "qtbase" "qtwebkit-examples" _is_qtwebkit_examples)
...
list(FIND _nobuild "qtbase" _dont_build_it)
if(NOT _dont_build_it EQUAL -1)
  hunter_status_debug(
      "Qt component doesn't install anything and will be skipped: qtbase"
  )
  return()
endif()

string(COMPARE EQUAL "qtbase" "qtdeclarative" _is_qtdeclarative)
