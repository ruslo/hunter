...
.. index::
  single: unsorted ; shaka_player_embedded

.. _pkg.shaka_player_embedded:
...
.. literalinclude:: /../examples/shaka_player_embedded/config.cmake
  :language: cmake
...
.. literalinclude:: /../examples/shaka_player_embedded/CMakeLists.txt
  :language: cmake
  :start-after: # DOCUMENTATION_START {
  :end-before: # DOCUMENTATION_END }
