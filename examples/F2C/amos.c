...
doublereal
dgamln_ (doublereal * z, integer * ierr)
{
  /* Initialized data */
...
/* Subroutine */
int
zacai_ (doublereal * zr, doublereal * zi, doublereal * fnu,
        integer * kode, integer * mr, integer * n, doublereal * yr,
        doublereal * yi, integer * nz, doublereal * rl, doublereal * tol,
        doublereal * elim, doublereal * alim)
{
  ...
  extern /* Subroutine */ int zbknu_ (doublereal *, doublereal *, doublereal
                                      *, integer *, integer *, doublereal *,
                                      doublereal *, integer *, doublereal *,
                                      doublereal *, doublereal *),
                                                 zseri_ (doublereal *, doublereal *, doublereal *, integer *, integer *,
  ...
  extern /* Subroutine */ int zmlri_ (doublereal *, doublereal *, doublereal
                                      *, integer *, integer *, doublereal *,
                                      doublereal *, integer *, doublereal *),
                                                 zasyi_ (doublereal *, doublereal *, doublereal *, integer *, integer *,
                                                     doublereal *, doublereal *, integer *, doublereal *, doublereal *,
                                                     doublereal *, doublereal *);
...
/* Subroutine */
int
zacon_ (doublereal * zr, doublereal * zi, doublereal * fnu,
        integer * kode, integer * mr, integer * n, doublereal * yr,
        doublereal * yi, integer * nz, doublereal * rl, doublereal * fnul,
        doublereal * tol, doublereal * elim, doublereal * alim)
{
  ...
  /* Builtin functions */
  double d_sign (doublereal *, doublereal *), cos (doublereal),
         sin (doublereal);
  ...
  extern /* Subroutine */ int zs1s2_ (doublereal *, doublereal *, doublereal
                                      *, doublereal *, doublereal *,
                                      doublereal *, integer *, doublereal *,
                                      doublereal *, integer *),
                                                 zmlt_ (doublereal *, doublereal *, doublereal *, doublereal *,
                                                     doublereal *, doublereal *);
  extern doublereal z1abs_ (doublereal *, doublereal *);
  ...
  extern /* Subroutine */ int zbinu_ (doublereal *, doublereal *, doublereal
                                      *, integer *, integer *, doublereal *,
                                      ...
                                      doublereal *, doublereal *,
                                      doublereal *, doublereal *),
                                                 zbknu_ (doublereal *, doublereal *, doublereal *, integer *, integer *,
                                                     doublereal *, doublereal *, integer *, doublereal *, doublereal *,
                                                     doublereal *);
  extern doublereal d1mach_ (integer *);
...
/* Subroutine */
int
zairy_ (doublereal * zr, doublereal * zi, integer * id,
        integer * kode, doublereal * air, doublereal * aii, integer * nz,
        integer * ierr)
{
  /* Initialized data */
...
zasyi_ (doublereal * zr, doublereal * zi, doublereal * fnu,
        ...
        integer * nz, doublereal * rl, doublereal * tol, doublereal * elim,
        doublereal * alim)
{
  /* Initialized data */
...
/* Subroutine */
int
zbesh_ (doublereal * zr, doublereal * zi, doublereal * fnu,
        integer * kode, integer * m, integer * n, doublereal * cyr,
        doublereal * cyi, integer * nz, integer * ierr)
{
  /* Initialized data */
  ...
  extern /* Subroutine */ int zbknu_ (doublereal *, doublereal *, doublereal
                                      *, integer *, integer *, doublereal *,
                                      doublereal *, integer *, doublereal *,
                                      doublereal *, doublereal *),
                                                 zbunk_ (doublereal *, doublereal *, doublereal *, integer *, integer *,
...
L90:
  ...
  zni = -zni;
L100:
  zbunk_ (&znr, &zni, fnu, kode, &mr, &nn, &cyr[1], &cyi[1], &nw, &tol, &elim,
          &alim);
  if (nw < 0)
    {
      goto L240;
...
/* Subroutine */
int
zbesi_ (doublereal * zr, doublereal * zi, doublereal * fnu,
        integer * kode, integer * n, doublereal * cyr, doublereal * cyi,
...
/* Subroutine */
int
zbesj_ (doublereal * zr, doublereal * zi, doublereal * fnu,
        integer * kode, integer * n, doublereal * cyr, doublereal * cyi,
        integer * nz, integer * ierr)
{
  /* Initialized data */
...
/* Subroutine */
int
zbesk_ (doublereal * zr, doublereal * zi, doublereal * fnu,
        integer * kode, integer * n, doublereal * cyr, doublereal * cyi,
        integer * nz, integer * ierr)
{
  /* System generated locals */
...
/* Subroutine */
int
zbesy_ (doublereal * zr, doublereal * zi, doublereal * fnu,
        integer * kode, integer * n, doublereal * cyr, doublereal * cyi,
        integer * nz, doublereal * cwrkr, doublereal * cwrki, integer * ierr)
{
  /* System generated locals */
  integer i__1, i__2;
  doublereal d__1, d__2;
...
/* Subroutine */
int
zbinu_ (doublereal * zr, doublereal * zi, doublereal * fnu,
        integer * kode, integer * n, doublereal * cyr, doublereal * cyi,
        integer * nz, doublereal * rl, doublereal * fnul, doublereal * tol,
        doublereal * elim, doublereal * alim)
{
  /* Initialized data */
  ...
  extern /* Subroutine */ int zbuni_ (doublereal *, doublereal *, doublereal
                                      *, integer *, integer *, doublereal *,
                                      ...
                                      doublereal *, doublereal *),
                                                 zseri_ (doublereal *, doublereal *, doublereal *, integer *, integer *,
                                                     doublereal *, doublereal *, integer *, doublereal *, doublereal *,
                                                     doublereal *), zmlri_ (doublereal *, doublereal *, doublereal *,
                                                         integer *, integer *, doublereal *,
                                                         doublereal *, integer *, doublereal *),
                                                 zasyi_ (doublereal *, doublereal *, doublereal *, integer *, integer *,
                                                     doublereal *, doublereal *, integer *, doublereal *, doublereal *,
                                                     doublereal *, doublereal *), zuoik_ (doublereal *, doublereal *,
                                                         doublereal *, integer *,
                                                         integer *, integer *,
                                                         doublereal *, doublereal *,
                                                         integer *, doublereal *,
                                                         doublereal *, doublereal *),
                                                 zwrsk_ (doublereal *, doublereal *, doublereal *, integer *, integer *,
                                                     doublereal *, doublereal *, integer *, doublereal *, doublereal *,
...
/* Subroutine */
int
zbiry_ (doublereal * zr, doublereal * zi, integer * id,
        integer * kode, doublereal * bir, doublereal * bii, integer * ierr)
{
  ...
  double exp (doublereal), pow_dd (doublereal *, doublereal *),
         sqrt (doublereal), log (doublereal), cos (doublereal), sin (doublereal);
...
/* Subroutine */
int
zbknu_ (doublereal * zr, doublereal * zi, doublereal * fnu,
        integer * kode, integer * n, doublereal * yr, doublereal * yi,
        integer * nz, doublereal * tol, doublereal * elim, doublereal * alim)
{
  /* Initialized data */
  ...
  /* Builtin functions */
  double sin (doublereal), exp (doublereal), cos (doublereal),
         atan (doublereal), sqrt (doublereal), log (doublereal);
  ...
  extern /* Subroutine */ int zuchk_ (doublereal *, doublereal *, integer *,
                                      doublereal *, doublereal *),
                                                 zkscl_ (doublereal *, doublereal *, doublereal *, integer *, doublereal *,
  ...
  static doublereal p1i, p2i, s1i, s2i, p2m, p1r, p2r, s1r, s2r, cbi, cbr,
         cki, caz, csi, ckr, fhs, fks, rak, czi, dnu, csr, elm, zdi, bry[3], pti,
         czr, sti, zdr, cyr[2], rzi, ptr, cyi[2];
  static integer inu;
...
/* Subroutine */
int
zbuni_ (doublereal * zr, doublereal * zi, doublereal * fnu,
        integer * kode, integer * n, doublereal * yr, doublereal * yi,
        integer * nz, integer * nui, integer * nlast, doublereal * fnul,
        doublereal * tol, doublereal * elim, doublereal * alim)
{
  /* System generated locals */
  integer i__1;
  ...
  extern /* Subroutine */ int zuni1_ (doublereal *, doublereal *, doublereal
                                      *, integer *, integer *, doublereal *,
                                      ...
                                      doublereal *, doublereal *,
                                      doublereal *, doublereal *),
                                                 zuni2_ (doublereal *, doublereal *, doublereal *, integer *, integer *,
...
/* Subroutine */
int
zbunk_ (doublereal * zr, doublereal * zi, doublereal * fnu,
        integer * kode, integer * mr, integer * n, doublereal * yr,
        doublereal * yi, integer * nz, doublereal * tol, doublereal * elim,
        doublereal * alim)
{
...
/* Subroutine */
int
zdiv_ (doublereal * ar, doublereal * ai, doublereal * br,
...
/* Subroutine */
int
zexp_ (doublereal * ar, doublereal * ai, doublereal * br, doublereal * bi)
{
  /* Builtin functions */
...
/* Subroutine */
int
zkscl_ (doublereal * zrr, doublereal * zri, doublereal * fnu,
        integer * n, doublereal * yr, doublereal * yi, integer * nz,
        doublereal * rzr, doublereal * rzi, doublereal * ascle,
        doublereal * tol, doublereal * elim)
{
  ...
  /* Builtin functions */
  double log (doublereal), exp (doublereal), cos (doublereal),
         sin (doublereal);
...
/* Subroutine */
int
zlog_ (doublereal * ar, doublereal * ai, doublereal * br,
...
L40:
  ...
  d__3 = tfnf + 1.;
  bk =
    dgamln_ (&d__1, &idum) - dgamln_ (&d__2, &idum) - dgamln_ (&d__3, &idum);
  bk = exp (bk);
  sumr = zeror;
  sumi = zeroi;
  km = kk - inu;
...
/* Subroutine */
int
zmlt_ (doublereal * ar, doublereal * ai, doublereal * br,
       doublereal * bi, doublereal * cr, doublereal * ci)
{
...
/* Subroutine */
int
zrati_ (doublereal * zr, doublereal * zi, doublereal * fnu,
...
/* Subroutine */
int
zs1s2_ (doublereal * zrr, doublereal * zri, doublereal * s1r,
        ...
        doublereal * ascle, doublereal * alim, integer * iuf)
{
  ...
  extern /* Subroutine */ int zlog_ (doublereal *, doublereal *, doublereal *
                                     , doublereal *, integer *),
                                     zexp_ (doublereal *, doublereal *, doublereal *, doublereal *);
  extern doublereal z1abs_ (doublereal *, doublereal *);
        ...
        integer * nz, doublereal * tol, doublereal * elim, doublereal * alim)
{
  ...
  /* Builtin functions */
  double sqrt (doublereal), exp (doublereal), cos (doublereal),
         sin (doublereal);
  ...
  extern /* Subroutine */ int zlog_ (doublereal *, doublereal *, doublereal *
                                     , doublereal *, integer *),
                                     zdiv_ (doublereal *, doublereal *, doublereal *, doublereal *,
                                         doublereal *, doublereal *), zmlt_ (doublereal *, doublereal *,
                                             doublereal *, doublereal *,
                                             doublereal *, doublereal *);
  extern doublereal z1abs_ (doublereal *, doublereal *);
...
/* Subroutine */
int
zshch_ (doublereal * zr, doublereal * zi, doublereal * cshr,
        doublereal * cshi, doublereal * cchr, doublereal * cchi)
{
  /* Builtin functions */
  double sinh (doublereal), cosh (doublereal), sin (doublereal),
         cos (doublereal);
...
/* Subroutine */
int
zsqrt_ (doublereal * ar, doublereal * ai, doublereal * br, doublereal * bi)
{
  /* Initialized data */
...
/* Subroutine */
int
zuchk_ (doublereal * yr, doublereal * yi, integer * nz,
...
/* Subroutine */
int
zunhj_ (doublereal * zr, doublereal * zi, doublereal * fnu,
        integer * ipmtr, doublereal * tol, doublereal * phir,
        doublereal * phii, doublereal * argr, doublereal * argi,
        doublereal * zeta1r, doublereal * zeta1i, doublereal * zeta2r,
        doublereal * zeta2i, doublereal * asumr, doublereal * asumi,
        doublereal * bsumr, doublereal * bsumi)
{
  /* Initialized data */
  ...
  /* Builtin functions */
  double log (doublereal), pow_dd (doublereal *, doublereal *),
         atan (doublereal), cos (doublereal), sin (doublereal), sqrt (doublereal);
...
/* Subroutine */
int
zuni1_ (doublereal * zr, doublereal * zi, doublereal * fnu,
        integer * kode, integer * n, doublereal * yr, doublereal * yi,
        integer * nz, integer * nlast, doublereal * fnul, doublereal * tol,
        doublereal * elim, doublereal * alim)
{
  /* Initialized data */
  ...
  extern /* Subroutine */ int zunik_ (doublereal *, doublereal *, doublereal
                                      *, integer *, integer *, doublereal *,
                                      ...
                                      doublereal *, doublereal *,
                                      doublereal *, doublereal *),
                                                 zuoik_ (doublereal *, doublereal *, doublereal *, integer *, integer *,
                                                     integer *, doublereal *, doublereal *, integer *, doublereal *,
                                                     doublereal *, doublereal *);
...
/* Subroutine */
int
zuni2_ (doublereal * zr, doublereal * zi, doublereal * fnu,
        integer * kode, integer * n, doublereal * yr, doublereal * yi,
        integer * nz, integer * nlast, doublereal * fnul, doublereal * tol,
        doublereal * elim, doublereal * alim)
{
  ...
  extern /* Subroutine */ int zunhj_ (doublereal *, doublereal *, doublereal
                                      *, integer *, doublereal *,
                                      ...
                                      doublereal *, doublereal *,
                                      doublereal *, doublereal *),
                                                 zairy_ (doublereal *, doublereal *, integer *, integer *, doublereal *,
                                                     doublereal *, integer *, integer *), zuoik_ (doublereal *,
                                                         doublereal *,
                                                         doublereal *,
                                                         integer *, integer *,
                                                         integer *,
...
/* Subroutine */
int
zunik_ (doublereal * zrr, doublereal * zri, doublereal * fnu,
        integer * ikflg, integer * ipmtr, doublereal * tol, integer * init,
        doublereal * phir, doublereal * phii, doublereal * zeta1r,
        doublereal * zeta1i, doublereal * zeta2r, doublereal * zeta2i,
        doublereal * sumr, doublereal * sumi, doublereal * cwrkr,
        doublereal * cwrki)
{
  /* Initialized data */
...
/* Subroutine */
int
zunk1_ (doublereal * zr, doublereal * zi, doublereal * fnu,
        integer * kode, integer * mr, integer * n, doublereal * yr,
        doublereal * yi, integer * nz, doublereal * tol, doublereal * elim,
        doublereal * alim)
{
  ...
  /* Builtin functions */
  double log (doublereal), exp (doublereal), cos (doublereal),
         sin (doublereal), d_sign (doublereal *, doublereal *);
  ...
  extern /* Subroutine */ int zunik_ (doublereal *, doublereal *, doublereal
                                      *, integer *, integer *, doublereal *,
                                      ...
                                      doublereal *, doublereal *,
                                      doublereal *, doublereal *);
  static doublereal zeta1i[2], zeta2i[2], zet1di, zet2di, zeta1r[2],
...
/* Subroutine */
int
zunk2_ (doublereal * zr, doublereal * zi, doublereal * fnu,
        integer * kode, integer * mr, integer * n, doublereal * yr,
        doublereal * yi, integer * nz, doublereal * tol, doublereal * elim,
        doublereal * alim)
{
  ...
  /* Builtin functions */
  double cos (doublereal), sin (doublereal), log (doublereal),
         exp (doublereal), d_sign (doublereal *, doublereal *);
...
/* Subroutine */
int
zuoik_ (doublereal * zr, doublereal * zi, doublereal * fnu,
        integer * kode, integer * ikflg, integer * n, doublereal * yr,
        doublereal * yi, integer * nuf, doublereal * tol, doublereal * elim,
        doublereal * alim)
{
  /* Initialized data */
  ...
  extern /* Subroutine */ int zunhj_ (doublereal *, doublereal *, doublereal
                                      *, integer *, doublereal *,
                                      ...
                                      doublereal *, doublereal *,
                                      doublereal *, doublereal *),
                                                 zunik_ (doublereal *, doublereal *, doublereal *, integer *, integer *,
                                                     doublereal *, integer *, doublereal *, doublereal *, doublereal *,
...
/* Subroutine */
int
zwrsk_ (doublereal * zrr, doublereal * zri, doublereal * fnu,
        integer * kode, integer * n, doublereal * yr, doublereal * yi,
        integer * nz, doublereal * cwr, doublereal * cwi, doublereal * tol,
        doublereal * elim, doublereal * alim)
{
  /* System generated locals */
  integer i__1;
  ...
  extern /* Subroutine */ int zbknu_ (doublereal *, doublereal *, doublereal
                                      *, integer *, integer *, doublereal *,
                                      doublereal *, integer *, doublereal *,
                                      doublereal *, doublereal *),
                                                 zrati_ (doublereal *, doublereal *, doublereal *, integer *, doublereal *,
                                                     doublereal *, doublereal *);
  extern doublereal d1mach_ (integer *);
  static integer nw;
